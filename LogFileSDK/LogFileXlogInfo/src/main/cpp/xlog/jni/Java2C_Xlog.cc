...
JNIEXPORT void JNICALL
Java_com_tencent_mars_xlog_Xlog_appenderOpen(JNIEnv *env, jclass clazz, jobject _log_config) {
    if (NULL == _log_config) {
        xerror2(TSF "logconfig is null");
        return;
    }
...
Java_com_tencent_mars_xlog_Xlog_getLogLevel(JNIEnv *, jobject, jlong _log_instance_ptr) {
    return mars::xlog::GetLevel(_log_instance_ptr);
}

JNIEXPORT void JNICALL
Java_com_tencent_mars_xlog_Xlog_setLogLevel(JNIEnv *, jobject, jlong _log_instance_ptr,
                                            jint _log_level) {
    mars::xlog::SetLevel(_log_instance_ptr, (TLogLevel) _log_level);
}

JNIEXPORT void JNICALL
Java_com_tencent_mars_xlog_Xlog_setAppenderMode(JNIEnv *, jobject, jlong _log_instance_ptr,
                                                jint _mode) {
