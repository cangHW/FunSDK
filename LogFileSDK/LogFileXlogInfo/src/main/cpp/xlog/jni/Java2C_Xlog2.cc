...
//Java_com_proxy_service_logfile_info_manager_LogFileCore_initTask(JNIEnv *env, jclass clazz, jobject config) {
//    jint level = callIntFrom(env, config, "getLevel");
//    jint syncMode = callIntFrom(env, config, "getSyncMode");
//    std::string logdir = callStringFrom(env, config, "getDir");
//    if (logdir.empty()) {
//        return false;
//    }
...
//        return false;
//    }
//    std::string path = logdir + namePrefix + namePostfix;
//    jint compressionMode = callIntFrom(env, config, "getCompressionMode");
//    jint compressionLevel = callIntFrom(env, config, "getCompressionLevel");
//    std::string encryptionKey = callStringFrom(env, config, "getEncryptionKey");
//
//    jint cacheDay = callIntFrom(env, config, "getCacheDays");
//    if (cacheDay <= 0) {
//        return false;
//    }
//    std::string cacheDir = callStringFrom(env, config, "getCacheDir");
////    jlong cleanTaskIntervalTime = callLongFrom(env, config, "getCleanTaskIntervalTime");
////    if (cleanTaskIntervalTime <= 0) {
////        return false;
////    }
////    clean_old_logs(logdir_str, cacheTime, cleanTaskIntervalTime);
//
////    jboolean isSync = callBooleanFrom(env, config, "isSyncMode");
////    jint type = callIntFrom(env, config, "getType");
//
//    mars::xlog::XLogConfig xConfig = {(mars::xlog::TAppenderMode) syncMode,
//                                     logdir,
//                                     namePrefix,
//                                      encryptionKey,
//                                     (mars::xlog::TCompressMode) compressionMode,
//                                      compressionLevel,
//                                      cacheDir,
//                                      cacheDay};
//    appender_open(xConfig);
...
//Java_com_tencent_mars_xlog_Xlog_appenderFlush(JNIEnv *env, jobject, jlong _log_instance_ptr,
//                                              jboolean _is_sync) {
...
//Java_com_tencent_mars_xlog_Xlog_newXlogInstance(JNIEnv *env, jobject, jobject _log_config) {
//    if (NULL == _log_config) {
...
//    jstring nameprefix = (jstring) JNU_GetField(env, _log_config, "nameprefix",
//                                                "Ljava/lang/String;").l;
...
//                                     cachedir_str,
//                                     cachedays};
//    mars::comm::XloggerCategory *category = mars::xlog::NewXloggerInstance(config,
//                                                                           (TLogLevel) level);
//    if (nullptr == category) {
//        return 0;
//    }
...
//
//JNIEXPORT jlong JNICALL
//Java_com_tencent_mars_xlog_Xlog_getXlogInstance(JNIEnv *env, jobject, jstring _nameprefix) {
//    ScopedJstring nameprefix_jstr(env, _nameprefix);
//    mars::comm::XloggerCategory *category = mars::xlog::GetXloggerInstance(
//            nameprefix_jstr.GetChar());
//    if (nullptr == category) {
//        return 0;
//    }
//    return reinterpret_cast<uintptr_t>(category);
...
//
//JNIEXPORT void JNICALL
//Java_com_tencent_mars_xlog_Xlog_releaseXlogInstance(JNIEnv *env, jobject, jstring _nameprefix) {
//    ScopedJstring nameprefix_jstr(env, _nameprefix);
...
//
//JNIEXPORT void JNICALL
//Java_com_tencent_mars_xlog_Xlog_logWrite(JNIEnv *env, jclass, jobject _log_info, jstring _log) {
...
//
//    mars::xlog::XloggerWrite(_log_instance_ptr, &xlog_info,
...
//
//JNIEXPORT void JNICALL
//Java_com_tencent_mars_xlog_Xlog_setConsoleLogOpen(JNIEnv *env, jobject, jlong _log_instance_ptr,
//                                                  jboolean _is_open) {
//    mars::xlog::SetConsoleLogOpen(_log_instance_ptr, _is_open);
//}
//
//JNIEXPORT void JNICALL
//Java_com_tencent_mars_xlog_Xlog_setMaxFileSize(JNIEnv *env, jobject, jlong _log_instance_ptr,
//                                               jlong _max_size) {
//    mars::xlog::SetMaxFileSize(_log_instance_ptr, _max_size);
//}
//
//JNIEXPORT void JNICALL
//Java_com_tencent_mars_xlog_Xlog_setMaxAliveTime(JNIEnv *env, jobject, jlong _log_instance_ptr,
//                                                jlong _max_time) {
