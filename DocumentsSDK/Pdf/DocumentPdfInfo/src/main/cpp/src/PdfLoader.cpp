...
// 通过文件描述符加载文档
extern "C" JNIEXPORT jobject JNICALL
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeOpenDocumentByFd(
...
// 通过文件 byte 数组加载文档
extern "C" JNIEXPORT jobject JNICALL
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeOpenDocumentByMem(
...
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeCloseDocument(
...
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeLoadPage(
...
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeLoadPages(
...
// 释放文档页面
extern "C" JNIEXPORT void JNICALL
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeClosePage(
...
// 批量释放文档页面
extern "C" JNIEXPORT void JNICALL
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeClosePages(
