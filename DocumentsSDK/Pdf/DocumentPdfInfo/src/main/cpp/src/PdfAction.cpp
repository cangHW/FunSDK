...
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeGetPageCount(
...
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeGetDocumentMetaText(
...
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeGetFirstChildBookmark(
...
// 获取文档目录的下一个目录指针
extern "C" JNIEXPORT jobject JNICALL
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeGetNextChildBookmark(
...
// 获取文档目录标题
extern "C" JNIEXPORT jstring JNICALL
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeGetBookmarkTitle(
...
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeGetBookmarkDestIndex(
        JNIEnv *env, jobject /*thiz*/, jlong docPtr, jlong bookmarkPtr) {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
    FPDF_BOOKMARK bookmark = reinterpret_cast<FPDF_BOOKMARK>(bookmarkPtr);
...
// 获取文档页面宽度: 像素
extern "C" JNIEXPORT jint JNICALL
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeGetPageWidthPixel(
...
// 获取文档页面高度: 像素
extern "C" JNIEXPORT jint JNICALL
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeGetPageHeightPixel(
        JNIEnv *env, jobject thiz, jlong pagePtr, jint dpi) {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
...
// 获取文档页面宽度: 点
extern "C" JNIEXPORT jint JNICALL
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeGetPageWidthPoint(
...
// 获取文档页面高度: 点
extern "C" JNIEXPORT jint JNICALL
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeGetPageHeightPoint(
        JNIEnv *env, jobject thiz, jlong pagePtr) {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
...
// 获取文档页面宽高
extern "C" JNIEXPORT jobject JNICALL
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeGetPageSizeByIndex(
    ...
    jclass clazz = env->FindClass("com/proxy/service/document/pdf/base/bean/PageSize");
...
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeGetPageLinks(
        JNIEnv *env, jobject /*thiz*/, jlong pagePtr) {
    FPDF_PAGE page = reinterpret_cast<FPDF_PAGE>(pagePtr);
    int pos = 0;
...
// 获取超链接对应的目标页码
extern "C" JNIEXPORT jobject JNICALL
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeGetDestPageIndex(
...
// 获取超链接对应的目标 uri
extern "C" JNIEXPORT jstring JNICALL
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeGetLinkURI(
        JNIEnv *env, jobject /*thiz*/, jlong docPtr, jlong linkPtr) {
    DocumentFile *doc = reinterpret_cast<DocumentFile *>(docPtr);
    FPDF_LINK link = reinterpret_cast<FPDF_LINK>(linkPtr);
...
// 获取超链接对应的坐标区域
extern "C" JNIEXPORT jobject JNICALL
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeGetLinkRectF(
