...
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeRenderPageToSurface(
...
// 渲染到 Bitmap
extern "C" JNIEXPORT void JNICALL
Java_com_proxy_service_document_pdf_info_core_PdfiumCore_nativeRenderPageToBitmap(
