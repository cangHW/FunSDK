...
import com.proxy.service.document.image.info.func.crop.controller.CropControllerImpl
...
open class CropLoaderImpl(
    ...
    protected var cropWidthPx: Float? = null
    protected var cropHeightPx: Float? = null
